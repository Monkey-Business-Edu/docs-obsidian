...
# Роли 
[Источник](https://vc.ru/u/1389654-machine-learning/625306-prostoe-rukovodstvo-po-chatgpt-api-s-ispolzovaniem-python)
## system
**Задать поведение помощника**. Вы можете назвать ассистента “полезным помощником, который переводит с английского на французский” или любым другим названием.
## assistant
Мы используем роль assistant для **хранения предыдущих ответов**. Сохраняя предыдущие ответы, мы можем создать историю разговоров, которая пригодится, когда инструкции user будут ссылаться на предыдущие сообщения. Или же аналогия, чтобы модель поняла, что это она сделала ранее.
```js
{"role": "assistant", "content": chat_response}
```
## user
Обычное сообщение запрос, которое модель рассматривает, как инструкцию действия или создания
